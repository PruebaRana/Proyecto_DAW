...
<div id="Centro" data-options="fit:false">
	...
	<div id="toolbar" style="display:none">
		<a id="Add" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'" onclick="javascript:Añadir('Añadir un nuevo ciclo', 310);" plain="true"></a>&nbsp;
		<a id="Edit" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit',disabled:true" onclick="javascript:Editar('\'Edición del ciclo \' + lItem.Nombre', 310);" plain="true"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<script>
	...
	var lsTitulo = 'Listado de ciclos';
	var lURLAñadir = '<?PHP echo(obtenURLController("Ciclo", "crear")); ?>';
	var lURLEdicion = '<?PHP echo(obtenURLController("Ciclo", "editar")); ?>&id=';
	var lURLEliminar = '<?PHP echo(obtenURLController("Ciclo", "eliminarid")); ?>&id=';
	var lURLListado = '<?php echo(obtenURLController("Ciclo", "ObtenerDatos")); ?>';
		...
		$(function () {
			$('#dg').datagrid({
				...
				columns: [[
					...
					{ field: 'Nombre', title: 'Nombre', width: 80, sortable: 'true', resizable: true},
					{ field: 'Descripcion', title: 'Descripcion', width: 400, sortable: 'true', resizable: true},
				]],
				idField: 'Id',
