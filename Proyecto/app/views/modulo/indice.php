...
<div id="Centro" data-options="fit:false">
	...
	<div id="toolbar" style="display:none">
		<a id="Add" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'" onclick="javascript:Añadir('Añadir un nuevo modulo', 310);" plain="true"></a>&nbsp;
		<a id="Edit" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit',disabled:true" onclick="javascript:Editar('\'Edición del modulo \' + lItem.Nombre', 310);" plain="true"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<div id="OpcionesBuscador" style="width:120px">
			...
			<div data-options="name:'Descripcion'">Descripcion</div>
...
<script>
	...
	var lsTitulo = 'Listado de modulos';
	var lURLAñadir = '<?PHP echo(obtenURLController("Modulo", "crear")); ?>';
	var lURLEdicion = '<?PHP echo(obtenURLController("Modulo", "editar")); ?>&id=';
	var lURLEliminar = '<?PHP echo(obtenURLController("Modulo", "eliminarid")); ?>&id=';
	var lURLListado = '<?php echo(obtenURLController("Modulo", "ObtenerDatos")); ?>';
		...
		$(function () {
			$('#dg').datagrid({
				...
				columns: [[
					...
					{ field: 'Ciclo', title: 'Ciclo', width: 50, sortable: 'true', resizable: 'true'},
					{ field: 'Nombre', title: 'Nombre', width: 50, sortable: 'true', resizable: 'true'},
					{ field: 'Descripcion', title: 'Descripcion', width: 500, sortable: 'true', resizable: 'true'},
				]],
				idField: 'Id',
