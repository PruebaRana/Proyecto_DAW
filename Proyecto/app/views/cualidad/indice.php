...
<div id="Centro" data-options="fit:false">
	...
	<div id="toolbar" style="display:none">
		<a id="Add" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'" onclick="javascript:Añadir('Añadir una nueva cualidad', 310);" plain="true"></a>&nbsp;
		<a id="Edit" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit',disabled:true" onclick="javascript:Editar('\'Edición de la cualidad \' + lItem.Nombre', 310);" plain="true"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<script>
	...
	var lsTitulo = 'Listado de cualidades';
	var lURLAñadir = '<?PHP echo(obtenURLController("Cualidad", "crear")); ?>';
	var lURLEdicion = '<?PHP echo(obtenURLController("Cualidad", "editar")); ?>&id=';
	var lURLEliminar = '<?PHP echo(obtenURLController("Cualidad", "eliminarid")); ?>&id=';
	var lURLListado = '<?php echo(obtenURLController("Cualidad", "ObtenerDatos")); ?>';
