...
<form action="<?PHP echo(obtenURLController("Cualidad", "editar")); ?>" class="form-horizontal" data-ajax="true" data-ajax-method="Post" data-ajax-mode="replace" data-ajax-update="#DivRespuesta" id="form" method="post">
	<br />
